...
* and if you are using the in-game piano, if there is a dot or comma ('.' ',') character between the piano keys in the game, replace it with other keys, suggestion 'b' key
